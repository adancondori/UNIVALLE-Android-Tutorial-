...
public class MyRecyclerViewAdapter extends RecyclerView.Adapter<MyRecyclerViewAdapter.ViewHolder> {
    private final ArrayList<User> appData;
    private final LayoutInflater inflateLayout;

    public MyRecyclerViewAdapter(ArrayList<User> appData, LayoutInflater inflateLayout) {
    ...
    public MyRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflateLayout.inflate(R.layout.row_user, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyRecyclerViewAdapter.ViewHolder holder, int position) {
        ...
        holder.txtDescripccion2.setText(appData.get(position).getEdad());
        //
    }
